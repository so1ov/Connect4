...
Connect4::PlayerAi::PlayerAi(char _ch)
	: Player(_ch)
{
...
int Connect4::PlayerAi::findFreeRow(int _column)
{
...
int Connect4::PlayerAi::sequenceOnDirection(C4GPoint _point, C4GPoint _direction)
{
	return sequenceOnDirectionForSpecifiedChip(this->chip_, _point, _direction);
}

int Connect4::PlayerAi::sequenceOnDirectionForSpecifiedChip(char _chip, C4GPoint _point, C4GPoint _direction)
{
	static char** field = this->attachedGame_->getField();
...
int Connect4::PlayerAi::possibleSequenceOnDirection(C4GPoint _point, C4GPoint _direction)
{
	return possibleSequenceOnDirectionForSpecifiedChip(this->chip_, _point, _direction);
}

int Connect4::PlayerAi::possibleSequenceOnDirectionForSpecifiedChip(char _chip, C4GPoint _point, C4GPoint _direction)
{
	static char** field = this->attachedGame_->getField();
	static int rows = this->attachedGame_->getRows();
	static int columns = this->attachedGame_->getColumns();
...
int Connect4::PlayerAi::maxSequence(C4GPoint _point)
{
	return maxSequenceForSpecifiedChip(this->chip_, _point);
}

int Connect4::PlayerAi::maxSequenceForSpecifiedChip(char _chip, C4GPoint _point)
{
	int currentSequence;
	int maxSequence = 0;
	C4GPoint direction;
...
int Connect4::PlayerAi::maxPossibleSequence(C4GPoint _point)
{
	return maxPossibleSequenceForSpecifiedChip(this->chip_, _point);
}

int Connect4::PlayerAi::maxPossibleSequenceForSpecifiedChip(char _chip, C4GPoint _point)
{
