...
int Connect4::Game::numberOfPairs = sizeof(Connect4::Game::oppositeDirections) / sizeof(Connect4::Game::oppositeDirections[0]);
int Connect4::Game::pairOfOppositeDirections = sizeof(Connect4::Game::oppositeDirections[0]) / sizeof(Connect4::Game::oppositeDirections[0][0]);
...
void Connect4::Game::initField(char**& _field, const int _rows, const int _columns, const char _cell)
{
...
Connect4::Game::Game(Connect4::Player* _p1, Connect4::Player* _p2, const int _rows = (int)DefaultOptions::Rows, const int _columns = (int)DefaultOptions::Columns)
{
	options_.rows = _rows;
...
Connect4::Game::Game(Player* _p1, Player* _p2)
	:	Game(_p1, _p2, (int)DefaultOptions::Rows, (int)DefaultOptions::Columns)
{
...
void Connect4::Game::attachView(Connect4::View* _view)
{
	this->attachedView_ = _view;
}

int Connect4::Game::maxSequenceForSpecifiedChip(const char _chip, const Point _point)
{
	int currentSequence;
	int maxSequence = 0;
	C4GPoint direction;
...
int Connect4::Game::sequenceOnDirectionForSpecifiedChip(const char _chip, const Point _point, const Point _direction)
{
